...
// in simulator we redefine to format for GDS Developer console
...
{\
	NSString * exceptionName = [@"org.gds." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.gds";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIGDSNativeItemNone = -1, 
	UIGDSNativeItemSpinner = -2,
	UIGDSNativeItemProgressBar = -3,
	
	UIGDSNativeItemSlider = -4,
	UIGDSNativeItemSwitch = -5,
	UIGDSNativeItemMultiButton = -6,
	UIGDSNativeItemSegmented = -7,
	
	UIGDSNativeItemTextView = -8,
	UIGDSNativeItemTextField = -9,
	UIGDSNativeItemSearchBar = -10,
	
	UIGDSNativeItemPicker = -11,
	UIGDSNativeItemDatePicker = -12,
	
	UIGDSNativeItemInfoLight = -13,
	UIGDSNativeItemInfoDark = -14,
	
	UIGDSNativeItemDisclosure = -15,
	
	UIGDSNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all GDS instances of
