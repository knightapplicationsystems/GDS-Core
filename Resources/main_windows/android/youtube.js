...
function serviceError() {
	failureMessage.message = "Unable to connect to youtube, Please try again later (For best results use a 3G or WiFi connection)";
	failureMessage.show();

	lblUnableToConnect = Titanium.UI.createLabel({
		text : 'Sorry we are unable to connect you to youtube at this time, please try again later',
		height : 'auto',
		top : '80dp',
		left : '10dp',
		color : 'White',
